    ...
    <>
      ...
      <main className='main'>
        ...
        <p>
          ...
          navigateurs web et lecteurs d'écran suivants : Firefox 106 et
          NVDA 2022
        </p>
        <p>
          Toutefois, ce site étant à but pédagogique et n'étant pas destiné à
          être en ligne, celle-ci n'a pas été rédigé (et la vérification de la
